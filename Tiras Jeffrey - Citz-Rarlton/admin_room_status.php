	...
	<div style="margin-left:25%;padding:1px 16px;height:1000px;">
		<p style="margin-left: 10%; margin-top: 5%; font-size: 28px;"></p>
			...
			<table class="basic_box">
				...
				<tr>
					<td></td>
					<td style="text-align: center;"><button style="font-family: 'Raleway', sans-serif;font-weight:bold;" type="submit">Confirm</button>
  					<button style="font-family: 'Raleway', sans-serif;font-weight:bold;" type="submit" formaction="cancel_room.php">Cancel Booking</button></td></form>	
				</tr>
			</table>
		</div>
	</body>
