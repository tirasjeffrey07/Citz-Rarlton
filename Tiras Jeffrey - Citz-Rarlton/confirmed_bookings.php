	...
	<div style="margin-left:25%;padding:1px 16px;height:1000px;">
		<p style="margin-left: 10%; margin-top: 5%; font-size: 28px;"></p>
			<table class="basic_box">
				<tr>
					<td colspan="12"><p style="font-size: 28px;align-items:center; text-align: center; text-decoration: underline;padding-left:11.5rem;"><b>Confirmed Bookings</b></p>
				</td>
				<tr>
					<th>Booking ID</th>
					<th></th>
			...
			<table class="basic_box">
				...
				<tr>
					<td></td>
					<td style="text-align: center;"><button style="font-family: 'Raleway', sans-serif;font-weight:bold;" type="submit">Change</button>
				</tr>
			</table>
		</div>
	</body>
